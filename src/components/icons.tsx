...
export const SunIcon = ({ className, ...rest }: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    ...
    >
      ...
      {React.createElement("set", { attributeName: "opacity", begin: "0.6s", to: "0" }) as any}
    </g>
    ...
    <circle
      ...
      opacity="0"
    >
      {React.createElement("set", { attributeName: "opacity", begin: "0.6s", to: "1" }) as any}
  ...
  >
    ...
    >
      ...
      <path
        ...
        opacity="0"
      >
        {React.createElement("set", { attributeName: "opacity", begin: "0.5s", to: "1" }) as any}
      </path>
    </g>
...
export const TwitterXIcon = ({ className, ...rest }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={42}
    ...
    >
      <path
        d="M25.383 18.633 39.418 3.582h-3.586L23.77 16.484 14.332 3.582H2.391l14.691 20.066-14.691 15.77h3.582L18.69 25.801l9.977 13.617h11.941ZM7.703 5.973h4.777l22.754 31.054h-4.777Zm0 0"
      />
    </svg>
  )
}

export const FacebookIcon = ({ className, ...rest }: SVGProps<SVGSVGElement>) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={100}
    ...
    >
      <path
        d="M36.75 0H5.25C2.355 0 0 2.41 0 5.375v32.25C0 40.59 2.355 43 5.25 43h31.5c2.895 0 5.25-2.41 5.25-5.375V5.375C42 2.41 39.645 0 36.75 0Zm0 0"
        style={{
          stroke: "none",
          fillRule: "nonzero",
          fill: "#1976d2",
      ...
      />
      <path
        d="M35.438 21.5h-6.563v-5.375c0-1.484 1.176-1.344 2.625-1.344h2.625V8.062h-5.25c-4.348 0-7.875 3.61-7.875 8.063V21.5h-5.25v6.719H21V43h7.875V28.219h3.938Zm0 0"
        style={{
          stroke: "none",
          fillRule: "evenodd",
          fill: "#fafafa",
