...
export async function generateMetadata({ params }:any) {
  ...
  const modifyAt = new Date(blog.updatedAt || blog.publishedAt).toISOString()
        ...
        <article>
          ...
          <div className="grid grid-cols-12  gap-y-8 lg:gap-8 sxl:gap-16 mt-8 px-5 md:px-10">
            <div className="col-span-12  lg:col-span-4">
              <details
                className="border-[1px] border-solid border-dark dark:border-light text-dark dark:text-light rounded-lg p-4 sticky top-6 lg:max-h-[calc(100vh-3rem)] max-h-[80vh]  overflow-hidden overflow-y-auto"
                open
              >
